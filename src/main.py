...
def main():
    fitness_function = FitnessFunction(max_sum=50,
                                       qty_values=[5, 4, 3, 2, 1, 6, 2, 3, 4, 5],
    ...
    gen_alg.initialize_population(size=350, chromosome_length=10)

    gen_alg.run(generations=1000, 
                parents_qty=280,
                verbose=False
                )
